...
if ( ! class_exists( 'Woo_Quick_View_Settings' ) ) {

	/**
	 * Define Woo_Quick_View_Settings class
	 */
	class Woo_Quick_View_Settings {
		...
		function __construct() {
			...
			add_action( 'woocommerce_settings_woo_quick_view', array( $this, 'render_settings_page' ) );
			add_action( 'woocommerce_update_options_woo_quick_view', array( $this, 'update_options' ) );
		...
		public function get_settings() {
			...
			return apply_filters( 'tw_woo_quick_view_settings', array(
				array(
					'id'    => 'general-options',
					'type'  => 'title',
					'title' => __( 'General Options', 'woocommerce-quick-view' ),
				),
				array(
					'type'    => 'checkbox',
					'id'      => 'woo_quick_view_on',
					'title'   => __( 'Enable Quick View button', 'woocommerce-quick-view' ),
					'desc'    => __( 'Show/Hide Quick View button', 'woocommerce-quick-view' ),
					'default' => 'yes'
				),
				array(
					'type'    => 'checkbox',
					'id'      => 'woo_quick_view_nav',
					'title'   => __( 'Enable product navigation mode', 'woocommerce-quick-view' ),
					'desc'    => __( 'Show/Hide prev and next product buttons', 'woocommerce-quick-view' ),
					'default' => 'yes'
				),
		...
		public function register_settings() {
			...
			$woocommerce_settings['woo_quick_view'] = $this->get_settings();
		}
		...
		public function register_settings_tab( $tabs ) {
			...
			$tabs['woo_quick_view'] = esc_html__( 'TM Quick View', 'woocommerce-quick-view' );
		 ...
		 *
		 * @since 1.0.0
		 * @action woocommerce_settings_woocompare_list
		 *
		 ...
		 *
		 * @since 1.0.0
		 * @action woocommerce_update_options_woocompare_list
		 */
...
/**
 * Returns instance of Woo_Quick_View_Settings
 *
 * @return object
 */
function woo_quick_view_settings() {
	return Woo_Quick_View_Settings::get_instance();
}

woo_quick_view_settings();
