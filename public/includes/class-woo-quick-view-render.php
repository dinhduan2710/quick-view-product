...
if ( ! class_exists( 'Woo_Quick_View_Render' ) ) {

	/**
	 * Define Woo_Quick_View_Render class
	 */
	class Woo_Quick_View_Render {
		...
		public function is_popup_enabled() {
			$enabled = get_option( 'woo_quick_view_on', 'yes' );
			return ( 'yes' === $enabled );
		}
		...
		public function prev_next_buttons() {
			...
			$show_buttons = get_option( 'woo_quick_view_nav', 'no' );
		...
		public function render_button() {
			...
			quick_view_assets()->add_product( get_the_id() );
		...
		public function locate_template( $template = null ) {
			...
			if ( ! $file ) {
				$file = woo_quick_view()->plugin_path( $plugin_path . $template );
			}
		...
		public function get_hook_data() {
			return apply_filters( 'woo_quick_view_button_hook', array(
...
/**
 * Returns instance of Woo_Quick_View_Render
 *
 * @return object
 */
function woo_quick_view_render() {
	return Woo_Quick_View_Render::get_instance();
}

woo_quick_view_render();
