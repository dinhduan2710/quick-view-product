...
if ( ! class_exists( 'Woo_Quick_View_Assets' ) ) {

	/**
	 * Define Woo_Quick_View_Assets class
	 */
	class Woo_Quick_View_Assets {
		...
		public function register_assets() {
			...
			$handle = 'woo-quick-view';

			wp_register_script(
				$handle,
				woo_quick_view()->plugin_url( 'public/assets/js/quick-view.js' ),
				array( 'jquery' ),
				'1.0.0',
				true
			);
			...
			wp_localize_script( $handle, 'tmQuickViewData', array(
				...
				'handle'   => $handle,
				'loader'   => woo_quick_view_render()->popup_loader( false ),
				'isSingle' => is_product(),
			) );

			wp_register_style(
				$handle,
				woo_quick_view()->plugin_url( 'public/assets/css/quick-view.css' ),
				array(),
				'1.0.0'
			);
...
/**
 * Returns instance of Woo_Quick_View_Assets
 *
 * @return object
 */
function quick_view_assets() {
	return Woo_Quick_View_Assets::get_instance();
}
